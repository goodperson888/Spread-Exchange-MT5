...
& $pythonExe -m PyInstaller --noconfirm --clean --onedir --name GoldPairLocal --collect-all MetaTrader5 --add-data 'index.html;.' --add-data 'app.js;.' --add-data 'trading-app.js;.' --add-data 'echarts.min.js;.' --add-data 'style.css;.' --add-data 'config.example.json;.' launcher.py
