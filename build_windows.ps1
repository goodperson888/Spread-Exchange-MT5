...
& $pythonExe -m PyInstaller --noconfirm --clean --onedir --name GoldPairLocal --collect-all MetaTrader5 --collect-all numpy --add-data 'index.html;.' --add-data 'app.js;.' --add-data 'trading-app.js;.' --add-data 'quote-stream.js;.' --add-data 'mt5;mt5' --add-data 'echarts.min.js;.' --add-data 'style.css;.' --add-data 'config.example.json;.' launcher.py
